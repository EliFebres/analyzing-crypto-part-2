...
def optimize_portfolio_sortino(tickers):
    ...
    constrain_crix = portfolios.loc[(portfolios['Downside Deviation'] < stock_data['Downside Deviation'])]
    best_sortino_pf = constrain_crix.loc[(constrain_crix['Sortino Ratio'].idxmax())]
    print(best_sortino_pf)
    ...
    plt.scatter(y=best_sortino_pf['Returns'], x=best_sortino_pf['Downside Deviation'], color='g', marker='*', s=400, label='Out-Of-Sample Portfolio')
